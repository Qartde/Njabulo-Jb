...
ezra({
  'nomCom': "follow",
  'aliases': ["supported", "jbcha", "foll", "following"],
  'reaction': '💬',
  ...
  try {
    ...
    await _0x2e61d5("*ᴡᴀɪᴛ ɴᴊᴀʙᴜʟᴏ ᴊʙ ɪs ғᴏʟʟᴏᴡ ᴛʜᴀᴛ ᴄʜᴀɴɴᴇʟ...*");
    const _0x386b0a = encodeURIComponent(_0x8621a4.join(" "));
    const _0x1ea92d = "https://whatsapp.com/channel/0029VarYP5iAInPtfQ8fRb2T=" + _0x386b0a;
